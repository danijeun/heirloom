      ...
      <main className="page">
        <aside className="sidebar">
          ...
          <div className="scan-image">
            {artifact.image_url ? (
              <img className="scan-image-photo" src={artifact.image_url} alt="Uploaded artifact" />
            ) : (
              <div
                role="img"
              ...
              >
                ...
                <p style={{ fontSize: "12px", margin: 0, opacity: 0.7 }}>The uploaded artifact image could not be loaded.</p>
              </div>
            )}
          </div>
